...
namespace FFexternalFileUpload\Integrations\DropboxIntegration;
...
class Bootstrap extends IntegrationManager
{
        ...
        if ($deletableFiles) {
            ...
            if ($success) {
                do_action('ff_integration_action_result', $feed, 'success',
                    'Dropbox feed file deletion has been successfully completed');
            }
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if ($responseArray[0]['is_downloadable'] == true) {
            ...
            do_action('ff_integration_action_result', $feed, 'success',
                'Dropbox feed has been successfully initialed and pushed file(s)');
