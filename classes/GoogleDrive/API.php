...
class API
{
    ...
    public function folderList()
    {
        ...
        $endPoint = 'files';
        return $this->makeRequest($this->baseUrl . $endPoint . '?q=' . $parameter, [], 'GET', $this->getStandardHeader());
    }
     ...
     */
    public function uploadFileDD($parentfileId, $filePath, $fileName = "none")
    {
        if ($fileName == "none") {
        ...
        //create file data using  google api lib
        ...
        return $this->makeRequest('https://www.googleapis.com/upload/drive/v3/files?uploadType=multipart',
            $body
        , 'POST', $headers);
