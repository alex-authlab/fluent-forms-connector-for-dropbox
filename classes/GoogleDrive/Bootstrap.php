...
namespace FFexternalFileUpload\GoogleDrive;

use FFexternalFileUpload\GoogleDrive\API;
...
class Bootstrap extends IntegrationManager
{
    ...
    public function __construct(Application $app)
    {
        ...
        $this->description = 'Connect Google Drive with FluentForm. Upload files directly to drive from your forms. Option to update database with shared file link & delete files from your server to free up space.';
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        foreach ($files as $file) {
            $response = $api->uploadFileDD($uploadFolderID, $file);
